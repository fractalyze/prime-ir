...
using namespace nb::literals;                  // NOLINT(build/namespaces)
using namespace tensorflow::profiler::python;  // NOLINT(build/namespaces)
  ...
  nb::class_<ProfileData>(m, "ProfileData")
      ...
      .def_static("from_text_proto",
                  [](const std::string& text_proto) {
                    ...
                    google::protobuf::TextFormat::ParseFromString(text_proto,
                                                                  xspace.get());
