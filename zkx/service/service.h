...
#ifndef ZKX_SERVICE_SERVICE_H_
#define ZKX_SERVICE_SERVICE_H_
...
// data in the associated ZKX service.
class GlobalData {
 public:
...
struct ZkxComputationInstance {
  const ZkxComputation& computation;
  std::vector<GlobalData*> arguments;
  ExecutionOptions execution_options;
  ExecutionProfile* execution_profile;

  ZkxComputationInstance(const ZkxComputation& computation,
                         std::vector<GlobalData*> arguments,
                         ExecutionOptions execution_options,
                         ExecutionProfile* execution_profile)
...
// The ZKX service object, which is the same across all platforms. It maintains
...
class Service {
 public:
  ...
  // Transfers data from the Outfeed of the device to the literal provided by
  // the client.
