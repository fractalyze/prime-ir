...
// compiler/zkx/backends/gpu/codegen/emitters.
...
// 'hero1' and 'hero2' are merged together. For example merging two fusions
// with a reduction hero and a transpose here, respectively, does not work.
...
// That is, the root tuple of the multi-output fusion will contain the
// results of both, the producer and consumer.
