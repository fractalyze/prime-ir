...
// TODO(batzor): Add BandwidthUtilizationRateHeuristicForTiledMemoryAccess.
// Dependency: TiledHloInstruction.

// TODO(batzor): Add IsTiledReadCoalescedHeuristic.
// Dependency: TiledHloInstruction.
...
Shape GetLinearizedShape(const Shape& shape) {
  ...
  *result.mutable_layout() = Layout({0});
  return result;
}
