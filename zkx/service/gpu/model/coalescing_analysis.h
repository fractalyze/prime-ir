...
// the MLIR indexing analysis paths present in ZKX.
...
//
// Note: the assumption is that the tile sizes do not include padding beyond the
// end of the shape.
// TODO(batzor): Uncomment this. Dependency: TiledHloInstruction.
...
//
// TODO(b/332714755): check whether we should bump up the granularity of memory
// transactions.
// TODO(batzor): Uncomment this. Dependency: TiledHloInstruction.
