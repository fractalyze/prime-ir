...
#ifndef ZKX_SERVICE_GPU_TRANSFORMS_VARIADIC_OP_SPLITTER_H_
#define ZKX_SERVICE_GPU_TRANSFORMS_VARIADIC_OP_SPLITTER_H_
...
class VariadicOpSplitter : public HloModulePass {
 public:
  std::string_view name() const override { return "variadic-op-splitter"; }
...
#endif  // ZKX_SERVICE_GPU_TRANSFORMS_VARIADIC_OP_SPLITTER_H_
