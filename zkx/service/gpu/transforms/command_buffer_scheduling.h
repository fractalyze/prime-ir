...
==============================================================================*/
#ifndef ZKX_SERVICE_GPU_TRANSFORMS_COMMAND_BUFFER_SCHEDULING_H_
#define ZKX_SERVICE_GPU_TRANSFORMS_COMMAND_BUFFER_SCHEDULING_H_
...
class CommandBufferScheduling : public HloModulePass {
 public:
  ...
  std::string_view name() const override { return "command-buffer-scheduling"; }
...
#endif  // ZKX_SERVICE_GPU_TRANSFORMS_COMMAND_BUFFER_SCHEDULING_H_
