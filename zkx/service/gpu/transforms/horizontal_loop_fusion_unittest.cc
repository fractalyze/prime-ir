...
TEST_F(HorizontalLoopFusionTest, BasicTest) {
 ...
 fused_computation.1 {
   arg.1 = s16[1024]{0} parameter(0)
   arg.2 = s16[1024]{0} parameter(1)
   ROOT mul.1 = s16[1024]{0} multiply(arg.1, arg.2)
 }

 fused_computation.2 {
   arg.1 = s16[123]{0} parameter(0)
   arg.2 = s16[123]{0} parameter(1)
   ROOT add.1 = s16[123]{0} add(arg.1, arg.2)
 }

 ENTRY entry_computation {
   arg.1 = s16[1024]{0} parameter(0)
   arg.2 = s16[1024]{0} parameter(1)
   arg.3 = s16[123]{0} parameter(2)
   arg.4 = s16[123]{0} parameter(3)
   fusion.1 = s16[1024]{0}
       fusion(arg.1, arg.2), kind=kLoop, calls=fused_computation.1
   fusion.2 = s16[123]{0}
       fusion(arg.3, arg.4), kind=kLoop, calls=fused_computation.2
   ROOT tuple.1 = (s16[1024]{0}, s16[123]{0})
...
TEST_F(HorizontalLoopFusionTest, NegativeTestForCycle) {
 ...
 fused_computation.1 {
   arg.1 = s16[123]{0} parameter(0)
   arg.2 = s16[123]{0} parameter(1)
   ROOT mul.1 = s16[123]{0} multiply(arg.1, arg.2)
 }
 ...
 ENTRY entry_computation {
   ...
   fusion.1 = s16[123]{0}
       fusion(arg.1, arg.2), kind=kLoop, calls=fused_computation.1
   add.2 = s16[123]{0} add(fusion.1, arg.4)
   fusion.2 = s16[123]{0}
       fusion(add.2, arg.3), kind=kLoop, calls=fused_computation.2
   ROOT tuple.1 = (s16[123]{0}, s16[123]{0}, s16[123]{0})
...
TEST_F(HorizontalLoopFusionTest, NegativeTestForIncompatibleTypes) {
 ...
 ENTRY entry_computation {
   ...
   fusion.2 = s32[123]{0}
       fusion(arg.3, arg.4), kind=kLoop, calls=fused_computation.2
   ROOT tuple.1 = (s16[1024]{0}, s32[123]{0})
       tuple(fusion.1, fusion.2)
 }
)")
                    .value();
...
TEST_F(HorizontalLoopFusionTest, NegativeTestForDifferentMemorySpace) {
 ...
 ENTRY main {
   arg0 = s32[1]{0} parameter(0)
   arg1 = s32[1]{0:S(5)} parameter(1)
   cp1 = s32[1]{0} copy(arg0)
   cp2 = s32[1]{0:S(5)} copy(arg1)
   ROOT tuple_out = (s32[1]{0}, s32[1]{0:S(5)}) tuple(cp1, cp2)
 }
)")
                    .value();
...
TEST_F(HorizontalLoopFusionTest, FusingIntoKLoopAndKInputTogether) {
 ...
 fused_computation.1 {
   arg.1 = s16[129, 2048]{1, 0} parameter(0)
   arg.2 = s16[129, 2048]{1, 0} parameter(1)
   ROOT mul.1 = s16[129,2048]{1, 0} multiply(arg.1, arg.2)
 }
 ...
 fused_computation.3 {
   arg.1 = s16[130, 2048]{1, 0} parameter(0)
   arg.2 = s16[130, 2048]{1, 0} parameter(1)
   ROOT mul.1 = s16[130,2048]{1, 0} multiply(arg.1, arg.2)
 }
 ...
 fused_computation.6 {
   arg.1 = s16[128]{0} parameter(0)
   arg.2 = s16[128]{0} parameter(1)
   ROOT add.1 = s16[128]{0} add(arg.1, arg.2)
 }

 ENTRY entry_computation {
   arg.1 = s16[129, 2048]{1, 0} parameter(0)
   arg.2 = s16[129, 2048]{1, 0} parameter(1)
   arg.3 = s16[129, 2048]{1, 0} parameter(2)
   arg.4 = s16[129, 2048]{1, 0} parameter(3)
   arg.5 = s16[130, 2048]{1, 0} parameter(4)
   arg.6 = s16[130, 2048]{1, 0} parameter(5)
   arg.7 = s16[130, 2048]{1, 0} parameter(6)
   arg.8 = s16[130, 2048]{1, 0} parameter(7)
   arg.9 = s16[123]{0} parameter(8)
   arg.10 = s16[123]{0} parameter(9)
   arg.11 = s16[128]{0} parameter(10)
   arg.12 = s16[128]{0} parameter(11)
   ...
   fusion.1 = s16[129,2048]{1, 0}
      fusion(arg.1, arg.2), kind=kLoop, calls=fused_computation.1

   fusion.2 = s16[129,2048]{1, 0}
      fusion(arg.3, arg.4), kind=kLoop, calls=fused_computation.2

   fusion.3 = s16[130,2048]{1, 0}
      fusion(arg.5, arg.6), kind=kLoop, calls=fused_computation.3

   fusion.4 = s16[130,2048]{1, 0}
   ...
   ROOT tuple.1 = (s16[129,2048]{1, 0}, s16[129,2048]{1, 0},
                   s16[130,2048]{1, 0}, s16[130,2048]{1, 0},
                   s16[123]{0}, s16[128]{0})
...
TEST_F(HorizontalLoopFusionTest, HorizontalLoopFusionAfterVerticalFusion) {
 ...
 ENTRY MergeSharedFusionInstruction.Computation0 {
  param.1.1   = s32[4,1024]{1,0} parameter(0)
  param.1.2   = s32[4,1024]{1,0} parameter(1)
  param.1.3   = s32[4,1024]{1,0} parameter(2)
  param.2.1   = s32[321,5]{1,0} parameter(3)
  param.2.2   = s32[321,5]{1,0} parameter(4)
  param.2.3   = s32[321,5]{1,0} parameter(5)
  const.1     = s32[] constant(3)
  const.2     = s32[] constant(3)
  broadcast.1 = s32[4,1024]{1,0} broadcast(const.1), dimensions={}
  broadcast.2 = s32[321,5]{1,0} broadcast(const.2), dimensions={}
  mul.1.1     = s32[4,1024]{1,0} multiply(param.1.1, param.1.2)
  mul.1.2     = s32[4,1024]{1,0} multiply(param.1.3, broadcast.1)
  add.1       = s32[4,1024]{1,0} add(mul.1.1, mul.1.2)
  mul.2.1     = s32[321,5]{1,0} multiply(param.2.1, param.2.2)
  mul.2.2     = s32[321,5]{1,0} multiply(param.2.3, broadcast.2)
  add.2       = s32[321,5]{1,0} add(mul.2.1, mul.2.2)
  ROOT tuple = (s32[4,1024]{1,0}, s32[321,5]{1,0}) tuple(add.1, add.2)
})")
                    .value();
  ...
  fusion.AddPass<PriorityFusion>(/*thread_pool=*/nullptr, device_info,
...
TEST_F(HorizontalLoopFusionTest, GradientDescentOptimizerLike) {
  ...
  for (int64_t i = 0; i < 128; ++i) {
    ...
    Shape shape = ShapeUtil::MakeShape(S32, {i + 1, 1024});
    ...
    HloInstruction* param_alpha =
        builder.AddInstruction(HloInstruction::CreateParameter(
            i * 3 + 1, ShapeUtil::MakeShape(S32, {}), "alpha"));
...
TEST_F(HorizontalLoopFusionTest, FusingDifferentOutputs) {
 ...
 fused_computation.1 {
   arg.1 = s16[1024]{0} parameter(0)
   arg.2 = s16[1024]{0} parameter(1)
   arg.3 = s16[1024]{0} parameter(2)
   arg.4 = s16[1024]{0} parameter(3)
   mul.1 = s16[1024]{0} multiply(arg.1, arg.2)
   mul.2 = s16[1024]{0} multiply(arg.3, arg.4)
   add.1 = s16[1024]{0} add(mul.1, mul.2)
   ROOT tuple.1 = (s16[1024]{0}, s16[1024]{0}) tuple(add.1, mul.1)
 }
 ...
 fused_computation.2 {
   ...
   arg.3 = s16[123]{0} parameter(2)
   arg.4 = s16[123]{0} parameter(3)
   add.1 = s16[123]{0} add(arg.1, arg.2)
   add.2 = s16[123]{0} add(arg.3, arg.4)
   mul.1 = s16[123]{0} multiply(add.1, add.2)
   ROOT tuple.1 = (s16[123]{0}, s16[123]{0}) tuple(mul.1, add.1)
 }
 ...
 ENTRY entry_computation {
   ...
   arg.3 = s16[1024]{0} parameter(2)
   arg.4 = s16[1024]{0} parameter(3)
   arg.5 = s16[123]{0} parameter(4)
   arg.6 = s16[123]{0} parameter(5)
   arg.7 = s16[123]{0} parameter(6)
   arg.8 = s16[123]{0} parameter(7)
   fusion.1 = (s16[1024]{0}, s16[1024]{0})
       fusion(arg.1, arg.2, arg.3, arg.4),
           kind=kLoop, calls=fused_computation.1
   fusion.2 = (s16[123]{0}, s16[123]{0})
       fusion(arg.5, arg.6, arg.7, arg.8),
           kind=kLoop, calls=fused_computation.2
   gte.1 = s16[1024]{0} get-tuple-element(fusion.1), index=0
   gte.2 = s16[1024]{0} get-tuple-element(fusion.1), index=1
   gte.3 = s16[123]{0} get-tuple-element(fusion.2), index=0
   gte.4 = s16[123]{0} get-tuple-element(fusion.2), index=1
   ROOT tuple.1 = (s16[1024]{0}, s16[1024]{0}, s16[123]{0}, s16[123]{0})
...
TEST_F(HorizontalLoopFusionTest, DynamicUpdateSlice) {
  ...
  fusion.1 {
    p.0 = s16[5,9,10]{2,1,0} parameter(0)
    p.1 = s32[] parameter(1)
    p.2 = s16[1,9,10]{2,1,0} parameter(2)
    c.0 = s32[] constant(0)
    ROOT %dynamic-update-slice =
        s16[5,9,10]{2,1,0} dynamic-update-slice(p.0, p.2, p.1, c.0, c.0)
  }
  ...
  ENTRY entry {
    p.00 = s16[5,9,10]{2,1,0} parameter(0)
    p.01 = s16[5,9,10]{2,1,0} parameter(1)
    p.10 = s32[] parameter(2)
    p.11 = s32[] parameter(3)
    p.20 = s16[1,9,10]{2,1,0} parameter(4)
    p.21 = s16[1,9,10]{2,1,0} parameter(5)

    f1 = s16[5,9,10] fusion(p.00, p.10, p.20), kind=kLoop, calls=fusion.1
    f2 = s16[5,9,10] fusion(p.01, p.11, p.21), kind=kLoop, calls=fusion.2
    ROOT tuple = (s16[5,9,10],s16[5,9,10]) tuple(f1, f2)
  })")
                    .value();
...
TEST_F(HorizontalLoopFusionTest,
 ...
 ENTRY entry_computation {
   ...
   ROOT tuple.1 = (s16[123]{0}, s16[123]{0})
       tuple(fusion.1, fusion.2)
 })")
                    .value();
...
e {
  p = s16[] parameter(0)
  a = s16[] fusion(p), kind=kLoop, calls=f
  b = s16[1] fusion(p), kind=kLoop, calls=g
  t = tuple(a, b)
})"));
...
TEST_F(HorizontalLoopFusionTest, IterativeHorizontalFusion) {
 ...
 fused_computation.0 {
   arg.0 = s16[] parameter(0)
   arg.1 = s16[123]{0} parameter(1)
   broadcast.0 = s16[123]{0} broadcast(arg.0), dimensions={}
   ROOT mul.1 = s16[123]{0} multiply(broadcast.0, arg.1)
 }

 fused_computation.1 {
   arg.0 = s16[] parameter(0)
   arg.1 = s16[456]{0} parameter(1)
   broadcast.0 = s16[456]{0} broadcast(arg.0), dimensions={}
   ROOT add.1 = s16[456]{0} add(broadcast.0, arg.1)
 }

 ENTRY entry_computation {
   arg.0 = s16[] parameter(0)
   arg.1 = s16[] parameter(1)
   arg.2 = s16[123]{0} parameter(2)
   arg.3 = s16[456]{0} parameter(3)
   // Test fusion of non-fusion instructions. negate.0 and negate.1 are to be
   // fused.
   negate.0 = s16[] negate(arg.0)
   negate.1 = s16[] negate(arg.1)
   // fusion.0 and fusion.1 are to be fused.
   fusion.0 = s16[123]{0}
       fusion(negate.0, arg.2), kind=kLoop, calls=fused_computation.0
   fusion.1 = s16[456]{0}
       fusion(negate.1, arg.3), kind=kLoop, calls=fused_computation.1
   ROOT tuple.1 = (s16[123]{0}, s16[456]{0}) tuple(fusion.0, fusion.1)
 }
)")
                    .value();
  ...
  // know negate.0 and negate.1 are fused.
  EXPECT_EQ(
...
TEST_F(HorizontalLoopFusionTest, TraversalOrder) {
 ...
 %fused_computation (param_0: s32[256,256], param_1: s32[], param_2: s32[])
     -> s32[256,256] {
   %param_0 = s32[256,256]{1,0} parameter(0)
   %param_1 = s32[] parameter(1)
   %param_2 = s32[] parameter(2)
   %multiply.0 = s32[] multiply(s32[] %param_1, s32[] %param_2)
   %broadcast.0 = s32[256,256]{1,0} broadcast(s32[] %multiply.0), dimensions={}
   ROOT %multiply.1 = s32[256,256]{1,0}
       multiply(s32[256,256]{1,0} %param_0, s32[256,256]{1,0} %broadcast.0)
 }

 %fused_computation.1 (param_0: s32[256,256], param_1: s32[], param_2: s32[])
     -> s32[256,256] {
   %param_0 = s32[256,256]{1,0} parameter(0)
   %param_1 = s32[] parameter(1)
   %param_2 = s32[] parameter(2)
 ...
 ENTRY %entry_computation (arg0: s32[256,256], arg1: s32[256,256], arg2: s32[],
                           arg3: s32[], arg4: s32[], arg5: s32[])
                               -> (s32[256,256], s32[256,256]) {
   %arg0 = s32[256,256]{1,0} parameter(0), parameter_replication={false}
   %arg1 = s32[256,256]{1,0} parameter(1), parameter_replication={false}
   %arg2 = s32[] parameter(2), parameter_replication={false}
   %arg3 = s32[] parameter(3), parameter_replication={false}
   %arg4 = s32[] parameter(4), parameter_replication={false}
   %arg5 = s32[] parameter(5), parameter_replication={false}
   %negate = s32[] negate(s32[] %arg2)
   %negate.1 = s32[] negate(s32[] %arg3)
   %fusion = s32[256,256]{1,0}
       fusion(s32[256,256]{1,0} %arg0, s32[] %negate, s32[] %negate.1),
       kind=kLoop, calls=%fused_computation
   %negate.2 = s32[] negate(s32[] %arg4)
   %negate.3 = s32[] negate(s32[] %arg5)
   %fusion.1 = s32[256,256]{1,0}
       fusion(s32[256,256]{1,0} %arg1, s32[] %negate.2, s32[] %negate.3),
       kind=kLoop, calls=%fused_computation.1
   ROOT %tuple.163 = (s32[256,256]{1,0}, s32[256,256]{1,0})
       tuple(s32[256,256]{1,0} %fusion.1, s32[256,256]{1,0} %fusion)
 }
)")
                    .value();
  ...
  // Verify that the total number of fusion instructions is 2 so that we
  // know all the negate instructions are fused into a kernel. Note that if we
...
// TODO(batzor): Uncomment this. Dependency: HandleConditional in
...
ENTRY main {
  cst = s32[1]{0} constant({0})
  cp1 = s32[1]{0} copy(cst)
  cp2 = s32[1]{0} copy(cst)
  cp3 = s32[1]{0} copy(cst)
  cp4 = s32[1]{0} copy(cst), control-predecessors={cp1}
  ROOT tuple_out = (s32[1]{0}, s32[1]{0}, s32[1]{0}, s32[1]{0}) tuple(cp1, cp2, cp3, cp4)
}
)";
...
TEST_F(HorizontalLoopFusionTest, DoNotMergeVariadicReductions) {
  ...
  ENTRY e {
    ...
    tmp_3 = s32[554112,10]{1,0} parameter(1)
    tmp_4 = (s32[554112]{0}, s32[554112]{0}) fusion(tmp_3), kind=kLoop, calls=fused_computation2
...
// TODO(batzor): Uncomment this. Dependency: MatchOptimizedHlo (requires full
...
TEST_F(HorizontalLoopFusionTest, DontFuseCopiesInsideWhileLoops) {
  TF_ASSERT_OK_AND_ASSIGN(auto module, ParseAndReturnVerifiedModule(R"(
HloModule module_main, entry_computation_layout={(s32[10]{0}, s32[20]{0})->(s32[], s32[10]{0}, s32[20]{0})}

f {
  param0 = s32[10]{0} parameter(0)
  reverse = s32[10]{0} reverse(param0), dimensions={0}
  param1 = s32[20]{0} parameter(1)
  param2 = s32[] parameter(2)
  dynamic_slice = s32[10]{0} dynamic-slice(param1, param2), dynamic_slice_sizes={10}
  ROOT res = s32[10]{0} add(reverse, dynamic_slice)
}

body {
  p0 = (s32[], s32[10]{0}, s32[20]{0}) parameter(0)
  iter = s32[] get-tuple-element(p0), index=0
  one = s32[] constant(1)
  next_iter = s32[] add(iter, one)
  a = s32[10]{0} get-tuple-element(p0), index=1
  b = s32[20]{0} get-tuple-element(p0), index=2
  next_a = s32[10]{0} fusion(a, b, iter), kind=kLoop, calls=f
  copy.0 = s32[10]{0} copy(next_a)
  next_b = s32[20]{0} reverse(b), dimensions={0}
  copy.1 = s32[20]{0} copy(next_b)
  ROOT r = (s32[], s32[10]{0}, s32[20]{0}) tuple(next_iter, copy.0, copy.1)
}

cond {
  p = (s32[], s32[10]{0}, s32[20]{0}) parameter(0)
...
ENTRY main {
  ...
  p1.0 = s32[20]{0} parameter(1)
  while_init = (s32[], s32[10]{0}, s32[20]{0}) tuple(zero, p0.1, p1.0)
  ROOT while = (s32[], s32[10]{0}, s32[20]{0}) while(while_init), condition=cond, body=body
})"));
