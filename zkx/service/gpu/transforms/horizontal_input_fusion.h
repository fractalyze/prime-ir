...
#ifndef ZKX_SERVICE_GPU_TRANSFORMS_HORIZONTAL_INPUT_FUSION_H_
#define ZKX_SERVICE_GPU_TRANSFORMS_HORIZONTAL_INPUT_FUSION_H_
...
class HorizontalInputFusion : public HloModulePass {
 public:
  ...
  std::string_view name() const override { return "horizontal_input_fusion"; }
...
#endif  // ZKX_SERVICE_GPU_TRANSFORMS_HORIZONTAL_INPUT_FUSION_H_
