...
#ifndef ZKX_SERVICE_GPU_TRANSFORMS_HORIZONTAL_LOOP_FUSION_H_
#define ZKX_SERVICE_GPU_TRANSFORMS_HORIZONTAL_LOOP_FUSION_H_
...
//
// case 2: if Mul and Add's output shape are different, then we fuse them into
...
class HorizontalLoopFusion : public HloModulePass {
 public:
  ...
  std::string_view name() const override { return "horizontal_loop_fusion"; }
...
#endif  // ZKX_SERVICE_GPU_TRANSFORMS_HORIZONTAL_LOOP_FUSION_H_
