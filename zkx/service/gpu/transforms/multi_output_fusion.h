...
#ifndef ZKX_SERVICE_GPU_TRANSFORMS_MULTI_OUTPUT_FUSION_H_
#define ZKX_SERVICE_GPU_TRANSFORMS_MULTI_OUTPUT_FUSION_H_
...
class MultiOutputFusion : public HloModulePass {
 public:
  ...
  std::string_view name() const override { return "multi_output_fusion"; }
 ...
 private:
  ...
  void DumpFusionState(const HloInstruction& consumer, std::string_view label,
...
#endif  // ZKX_SERVICE_GPU_TRANSFORMS_MULTI_OUTPUT_FUSION_H_
