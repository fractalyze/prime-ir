...
#ifndef ZKX_SERVICE_HUMAN_READABLE_PROFILE_BUILDER_H_
#define ZKX_SERVICE_HUMAN_READABLE_PROFILE_BUILDER_H_
...
class HumanReadableProfileBuilder {
 public:
  explicit HumanReadableProfileBuilder(std::string_view computation_name,
  ...
  void AddOp(std::string_view op_name, std::string_view short_name,
             std::string_view category, int64_t cycles, int64_t flop_count,
...
#endif  // ZKX_SERVICE_HUMAN_READABLE_PROFILE_BUILDER_H_
