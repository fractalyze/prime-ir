...
#ifndef ZKX_SERVICE_HLO_EXECUTION_PROFILE_H_
#define ZKX_SERVICE_HLO_EXECUTION_PROFILE_H_
...
#include "zkx/service/hlo_execution_profile_data.pb.h"
#include "zkx/service/hlo_profile_printer.h"
...
class HloProfileIndexMap {
 public:
  ...
  size_t GetProfileIndexFor(const std::string& key) const {
    return FindOrDie(extra_metric_to_profile_idx(), key);
  }
...
#endif  // ZKX_SERVICE_HLO_EXECUTION_PROFILE_H_
