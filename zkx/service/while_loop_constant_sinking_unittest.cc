...
body {
  ...
  p_body.0 = s32[2] get-tuple-element((s32[2],s32[2]) p_body), index=0
  p_body.1 = s32[2] get-tuple-element((s32[2],s32[2]) p_body), index=1

  add.0 = s32[2] add(p_body.0, p_body.1)
  ROOT root = (s32[2],s32[2]) tuple(add.0, p_body.1)
}
...
ENTRY entry {
  const_0 = s32[2] constant({1, 2})
  const_1 = s32[2] constant({2, 1})
  while_init = (s32[2],s32[2]) tuple(const_0, const_1)
  ROOT while = (s32[2],s32[2]) while(while_init), condition=condition, body=body
}
)";
...
body {
  p_body = (s32[16],s32[16]) parameter(0)
...
condition {
  p_cond = (s32[16],s32[16]) parameter(0)
  ROOT result = pred[] constant(true)
}

ENTRY entry {
  const_0 = s32[] constant(1)
  const_1 = s32[] constant(2)
  broadcast_0 = s32[16] broadcast(const_0), dimensions={}
  broadcast_1 = s32[16] broadcast(const_1), dimensions={}
...
body {
  p_body = (s32[2],s32[2],s32[2]) parameter(0)
  p_body.0 = s32[2] get-tuple-element((s32[2],s32[2],s32[2]) p_body), index=0
  p_body.1 = s32[2] get-tuple-element((s32[2],s32[2],s32[2]) p_body), index=1
  p_body.2 = s32[2] get-tuple-element((s32[2],s32[2],s32[2]) p_body), index=2

  add.0 = s32[2] add(p_body.1, p_body.2)
  ROOT root = (s32[2],s32[2],s32[2]) tuple(add.0, p_body.1, p_body.2)
}

condition {
  p_cond = (s32[2],s32[2],s32[2]) parameter(0)
  ROOT result = pred[] constant(true)
}
...
ENTRY entry {
  const_0 = s32[2] constant({1, 2})
  const_1 = s32[2] constant({2, 1})
  const_2 = s32[2] constant({3, 1})
  while_init = (s32[2],s32[2],s32[2]) tuple(const_0, const_1, const_2)
  ROOT while = (s32[2],s32[2],s32[2]) while(while_init), condition=condition, body=body
}
)";
...
body {
  p_b = (s32[2],(s32[2],s32[2])) parameter(0)
  p_b.0 = s32[2] get-tuple-element((s32[2],(s32[2],s32[2])) p_b), index=0
  p_b.1 = (s32[2],s32[2]) get-tuple-element((s32[2],(s32[2],s32[2])) p_b), index=1

  p_b.1.1 = s32[2] get-tuple-element(p_b.1), index=0

  ROOT root = (s32[2],(s32[2],s32[2])) tuple(p_b.1.1, p_b.1)
}
...
ENTRY entry {
  const_0 = s32[2] constant({1, 2})
  const_1 = (s32[2], s32[2]) constant(({2, 1},{3,1}))
  while_init = (s32[2],(s32[2],s32[2])) tuple(const_0, const_1)
  ROOT while = (s32[2],(s32[2],s32[2])) while(while_init), condition=condition, body=body
}
)";
...
body {
  ...
  p_b.1     = s32[2] get-tuple-element((s32[2],s32[2],s32[2]) p_b), index=1
  p_b.2     = s32[2] get-tuple-element((s32[2],s32[2],s32[2]) p_b), index=2
  p_b.2.dup = s32[2] get-tuple-element((s32[2],s32[2],s32[2]) p_b), index=2

  add.0 = s32[2] add(p_b.1, p_b.2.dup)
  ROOT root = (s32[2],s32[2],s32[2]) tuple(add.0, p_b.1, p_b.2)
}
...
body {
  ...
  ROOT root = (s32[2],s32[2],s32[2]) tuple(p_body.0, p_body.1, p_body.1)
}
...
ENTRY entry {
  ...
  const_1 = s32[2] constant({2, 1})
  while_init = (s32[2],s32[2]) tuple(const_0, const_1)
  ROOT while = (s32[2],s32[2],s32[2]) while(while_init), condition=condition,
                                      body=body
}
)";
...
condition {
  ...
  p_cond.1 = s32[] get-tuple-element((s32[],s32[]) p_cond), index=1
...
body {
  p_b = (s32[],(s32[],s32[])) parameter(0)
  p_b.0 = s32[] get-tuple-element((s32[],(s32[],s32[])) p_b), index=0
  p_b.1 = (s32[],s32[]) get-tuple-element((s32[],(s32[],s32[])) p_b), index=1
  p_b.1.0 = s32[] get-tuple-element((s32[],s32[]) p_b.1), index=0
  add = s32[] add(p_b.0, p_b.1.0)
  ROOT root = (s32[],(s32[],s32[])) tuple(add, p_b.1)
}

condition {
  p_c = (s32[],(s32[],s32[])) parameter(0)
  p_c.0 = s32[] get-tuple-element((s32[],(s32[],s32[])) p_c), index=0
  p_c.1 = (s32[],s32[]) get-tuple-element((s32[],(s32[],s32[])) p_c), index=1
  p_c.1.1 = s32[] get-tuple-element((s32[],s32[]) p_c.1), index=1
  ROOT result = pred[] compare(p_c.0, p_c.1.1), direction=LT
}

ENTRY entry {
  const_0 = s32[] constant(0)
  const_1 = (s32[], s32[]) constant((1, 10))
  while_init = (s32[],(s32[],s32[])) tuple(const_0, const_1)
...
body {
  ...
  ROOT root = (s32[],s32[],s32[]) tuple(add, p_body.1, p_body.2)
}

condition {
  p_cond = (s32[],s32[],s32[]) parameter(0)
  p_cond.0 = s32[] get-tuple-element((s32[],s32[],s32[]) p_cond), index=0
  p_cond.1 = s32[] get-tuple-element((s32[],s32[],s32[]) p_cond), index=1
  p_cond.2 = s32[] get-tuple-element((s32[],s32[],s32[]) p_cond), index=2
  ROOT result = pred[] compare(p_cond.0, p_cond.1), direction=LT
}
...
body {
  ...
  p_body.0 = s32[] get-tuple-element((s32[],s32[],s32[]) p_body), index=0
  const = s32[] constant(1)
  add.0 = s32[] add(p_body.0, const)
  p_body.1 = s32[] get-tuple-element((s32[],s32[],s32[]) p_body), index=1
  add.1 = s32[] add(p_body.1, const)
  p_body.2 = s32[] get-tuple-element((s32[],s32[],s32[]) p_body), index=2
  ROOT root = (s32[],s32[],s32[]) tuple(add.0, add.1, p_body.2)
}
...
condition {
  ...
  p_cond.1 = s32[] get-tuple-element((s32[],s32[],s32[]) p_cond), index=1
  p_cond.2.c = s32[] get-tuple-element((s32[],s32[],s32[]) p_cond), index=2
...
ENTRY entry {
  ...
  const_1 = s32[2] constant({2, 1})
  while_init = (s32[2],s32[2]) tuple(const_0, const_1)
  while = (s32[2],s32[2]) while(while_init), condition=condition, body=body
  while_init2 = (s32[2],s32[2]) tuple(const_1, const_0)
  while2 = (s32[2],s32[2]) while(while_init2), condition=condition, body=body
  ROOT tuple = ((s32[2],s32[2]),(s32[2],s32[2])) tuple(while, while2)
}
)";
  ...
  EXPECT_THAT(
      ...
      op::Tuple(
          op::Add(_, op::Constant(LiteralUtil::CreateR1<int32_t>({2, 1}))), _));
  while_body = module->GetComputationWithName("body.sunk.1");
  EXPECT_THAT(
      while_body->root_instruction(),
      op::Tuple(
          op::Add(_, op::Constant(LiteralUtil::CreateR1<int32_t>({1, 2}))), _));
}
