...
#ifndef ZKX_SERVICE_SCATTER_SIMPLIFIER_H_
#define ZKX_SERVICE_SCATTER_SIMPLIFIER_H_
...
class ScatterSimplifier : public OpExpanderPass {
 public:
  std::string_view name() const override { return "scatter_simplifier"; }
...
#endif  // ZKX_SERVICE_SCATTER_SIMPLIFIER_H_
