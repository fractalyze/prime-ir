...
#ifndef ZKX_SERVICE_WHILE_LOOP_UNROLLER_H_
#define ZKX_SERVICE_WHILE_LOOP_UNROLLER_H_
...
// zkx/hlo/analysis/while_loop_analysis.h`
//
...
class WhileLoopUnroller : public HloModulePass {
 public:
  ...
  std::string_view name() const override { return "while_loop_unroller"; }
...
#endif  // ZKX_SERVICE_WHILE_LOOP_UNROLLER_H_
