...
#ifndef ZKX_SERVICE_ALLOCATION_TRACKER_H_
#define ZKX_SERVICE_ALLOCATION_TRACKER_H_
...
// Tracks allocations for the ZKX service; allocations can be registered
...
class AllocationTracker {
 public:
  ...
  // handle that can be used for talking to ZKX clients. The given shaped buffer
  ...
  // returns a corresponding handle that can be used for talking to ZKX clients.
  ...
  // Resolve a handle from a ZKX client to a vector of shaped buffers, one per
  ...
  // Resolves a handle from a ZKX client and replica id to a shaped buffer, or
 ...
 private:
  ...
  struct Allocation {
    ...
    se::ScopedDeviceMemory<uint8_t> device_memory;
...
#endif  // ZKX_SERVICE_ALLOCATION_TRACKER_H_
