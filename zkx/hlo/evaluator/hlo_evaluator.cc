...
ShapeUtil::IndexIterationSpace GetIterationSpaceImpl(
  ...
  for (int64_t i = 0; i < updates_rank; i++) {
    if constexpr (kForUpdateWindowIndices) {
...
// Returns an IndexIterationSpace that iterates over the update scatter
// dimensions while keeping the rest of the update dimensions clamped to 0.
...
// Return an IndexIterationSpace that iterates over the update window
// dimensions while keeping the rest of the update dimensions clamped to 0.
