...
#ifndef ZKX_HLO_TRANSFORMS_EXPANDERS_RESHAPE_DECOMPOSER_H_
#define ZKX_HLO_TRANSFORMS_EXPANDERS_RESHAPE_DECOMPOSER_H_
...
class ReshapeDecomposer : public HloModulePass {
 public:
  std::string_view name() const override { return "reshape-decomposer"; }
...
#endif  // ZKX_HLO_TRANSFORMS_EXPANDERS_RESHAPE_DECOMPOSER_H_
