...
// CHECK: %zkx.bitcast_convert_s32_10__2_s8_10_4_.17 (a.1: s32[10]) -> s8[10,4] {
...
// CHECK: %zkx.bitcast_convert_s64_10__2_s32_10_2_.17 (a.1: s64[10]) -> s32[10,2] {
...
// CHECK: }
// CHECK: %zkx.bitcast_convert_s8_10_4__2_s32_10_.16 (a.1: s8[10,4]) -> s32[10] {
...
body {
  p_body = (u32[2], s32[]) parameter(0)
  val1 = u32[2] get-tuple-element(p_body), index=0
  ...
  ROOT root = (u32[2], s32[]) tuple(val1, out_add)
}

condition {
  p_cond = (u32[2], s32[]) parameter(0)
...
ENTRY entry {
  param.0 = u32[2] parameter(0)
  param.1 = s32[] parameter(1)
  while_init = (u32[2], s32[]) tuple(param.0, param.1)
  ROOT while = (u32[2], s32[]) while(while_init), condition=condition, body=body
}
)";
  TF_ASSERT_OK_AND_ASSIGN(std::unique_ptr<HloModule> module,
                          ParseAndReturnVerifiedModule(hlo_string));
