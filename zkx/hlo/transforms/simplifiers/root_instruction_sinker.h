...
#ifndef ZKX_HLO_TRANSFORMS_SIMPLIFIERS_ROOT_INSTRUCTION_SINKER_H_
#define ZKX_HLO_TRANSFORMS_SIMPLIFIERS_ROOT_INSTRUCTION_SINKER_H_
...
class RootInstructionSinker : public HloModulePass {
 public:
  ...
  std::string_view name() const override { return "root-instruction-sinker"; }
...
#endif  // ZKX_HLO_TRANSFORMS_SIMPLIFIERS_ROOT_INSTRUCTION_SINKER_H_
