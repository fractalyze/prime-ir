...
#ifndef ZKX_HLO_TRANSFORMS_SIMPLIFIERS_CONDITIONAL_CANONICALIZER_H_
#define ZKX_HLO_TRANSFORMS_SIMPLIFIERS_CONDITIONAL_CANONICALIZER_H_
...
class ConditionalCanonicalizer : public HloModulePass {
 public:
  std::string_view name() const override { return "conditional-canonicalizer"; }
...
#endif  // ZKX_HLO_TRANSFORMS_SIMPLIFIERS_CONDITIONAL_CANONICALIZER_H_
