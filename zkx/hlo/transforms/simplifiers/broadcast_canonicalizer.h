...
#ifndef ZKX_HLO_TRANSFORMS_SIMPLIFIERS_BROADCAST_CANONICALIZER_H_
#define ZKX_HLO_TRANSFORMS_SIMPLIFIERS_BROADCAST_CANONICALIZER_H_
...
class BroadcastCanonicalizer : public HloModulePass {
 public:
  ...
  std::string_view name() const override { return "broadcast_canonicalizer"; }
...
#endif  // ZKX_HLO_TRANSFORMS_SIMPLIFIERS_BROADCAST_CANONICALIZER_H_
