...
absl::StatusOr<int64_t> WhileLoopAnalysisTest::MakeWhileLoopAndGetTripCount(
  ...
  HloModule ModuleWithWhile
    ...
    body {
      p_body = (s32[2], s32[]) parameter(0)
      val = s32[2] get-tuple-element(p_body), index=0
      index = s32[] get-tuple-element(p_body), index=1
      one = s32[] constant({{STEP}})
      inc = s32[] add(index, one)
      ROOT root = (s32[2], s32[]) tuple(val, inc)
    }

    condition {
      p_cond = (s32[2], s32[]) parameter(0)
    ...
    ENTRY entry {
      ...
      while_init = (s32[2], s32[]) tuple(param.0, param.1)
      ROOT while = (s32[2], s32[]) while(while_init), condition=condition, body=body
    }
  )";
...
TEST_F(WhileLoopAnalysisTest, SingleIterationUpperBound) {
  const char* const kHloModule = R"(
    ...
    body {
      ...
      ROOT root = (s32[2], s32[]) tuple(val, const)
    }
...
TEST_F(WhileLoopAnalysisTest, NoAIVNoConstChain) {
  const char* const kHloModule = R"(
    ...
    body {
      p_body = (s32[2], s32[], s32[]) parameter(0)
      val1 = s32[2] get-tuple-element(p_body), index=0
      ...
      ROOT root = (s32[2], s32[], s32[]) tuple(val1, add, sub)
    }

    condition {
      p_cond = (s32[2], s32[], s32[]) parameter(0)
      gte = s32[] get-tuple-element(p_cond), index=1
      const = s32[] constant(42)
      ROOT result = pred[] compare(gte, const), direction=EQ
    }
    ...
    ENTRY entry {
      ...
      while_init = (s32[2], s32[], s32[]) tuple(param.0, param.1, param.2)
      ROOT while = (s32[2], s32[], s32[]) while(while_init), condition=condition, body=body
    })";
  TF_ASSERT_OK_AND_ASSIGN(std::unique_ptr<HloModule> module,
                          ParseAndReturnVerifiedModule(kHloModule));
...
TEST_F(WhileLoopAnalysisTest, AIVMultiChain) {
  const char* const kHloModule = R"(
    ...
    body {
      ...
      ROOT root = (s32[2], s32[]) tuple(val1, mul)
    }
...
TEST_F(WhileLoopAnalysisTest, NoAIV) {
  const char* const kHloModule = R"(
    ...
    body {
      ...
      ROOT root = (s32[2], s32[]) tuple(val1, div)
    }
...
TEST_F(WhileLoopAnalysisTest, AIVNoChain) {
  const char* const kHloModule = R"(
    ...
    body {
      ...
      ROOT root = (s32[2], s32[]) tuple(val1, add)
    }
...
// TODO(chokobole): Enable test. Dependency: AlgebraicSimplifier
TEST_F(WhileLoopAnalysisTest,
       DISABLED_GetIndvarIndexShouldWorkWhenParamIsCopied) {
  const char* hlo = R"(
    HloModule test
