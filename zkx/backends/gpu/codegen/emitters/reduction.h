...
==============================================================================*/
#ifndef ZKX_BACKENDS_GPU_CODEGEN_EMITTERS_REDUCTION_H_
#define ZKX_BACKENDS_GPU_CODEGEN_EMITTERS_REDUCTION_H_
...
class ReductionFusion : public EmitterBase {
 ...
 protected:
  ...
  int64_t WarpSize() const {
    return ::zkx::gpu::WarpSize(analysis_.device_info());
  }
...
#endif  // ZKX_BACKENDS_GPU_CODEGEN_EMITTERS_REDUCTION_H_
