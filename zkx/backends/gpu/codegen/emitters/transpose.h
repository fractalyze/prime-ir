...
==============================================================================*/
#ifndef ZKX_BACKENDS_GPU_CODEGEN_EMITTERS_TRANSPOSE_H_
#define ZKX_BACKENDS_GPU_CODEGEN_EMITTERS_TRANSPOSE_H_
...
class TransposeFusion : public EmitterBase {
 ...
 private:
  ...
  IndexingMap GetIndexing(bool input, const Shape& shape,
...
#endif  // ZKX_BACKENDS_GPU_CODEGEN_EMITTERS_TRANSPOSE_H_
