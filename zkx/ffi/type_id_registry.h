...
#ifndef ZKX_FFI_TYPE_ID_REGISTRY_H_
#define ZKX_FFI_TYPE_ID_REGISTRY_H_
...
// ZKX FFI has a several APIs that can take ownership of an opaque user data,
// and then passes it back to the FFI handler via the execution context:
//
// 1. UserData put into the ExecutionContext
// 2. ZKX FFI handler state created at instantiation stage
//
...
#endif  // ZKX_FFI_TYPE_ID_REGISTRY_H_
