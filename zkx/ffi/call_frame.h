...
#ifndef ZKX_FFI_CALL_FRAME_H_
#define ZKX_FFI_CALL_FRAME_H_
...
// CallFrame library encodes C++ arguments using ZKX FFI C API structs in a form
...
class CallFrame {
 public:
  ...
  //
  // For any particular instance of a custom call in the ZKX program, all
  ...
  // Builds an ZKX_FFI_CallFrame from owned arguments and attributes.
  ZKX_FFI_CallFrame Build(
 ...
 private:
  ...
  // Fixes up call frame arguments by initializing ZKX FFI structs with valid
  ...
  // Fixes up call frame results by initializing ZKX FFI structs with valid
  // pointers into storage objects.
  ...
  // Fixes up call frame attributes by initializing ZKX FFI structs with valid
  // pointers into storage objects.
