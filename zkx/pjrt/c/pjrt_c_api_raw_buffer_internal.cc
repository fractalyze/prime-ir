...
#include "zkx/pjrt/c/pjrt_c_api_raw_buffer_internal.h"
...
struct PJRT_RawBuffer {
  tsl::RCReference<zkx::PjRtRawBuffer> buffer;
  PJRT_Client* client;
};
...
PJRT_Error* PJRT_RawBuffer_CreateRawAliasOfBuffer(
  ...
  PJRT_RETURN_IF_ERROR(ActualStructSizeIsGreaterOrEqual(
      ...
      args->struct_size));
  PJRT_ASSIGN_OR_RETURN(auto result, zkx::PjRtRawBuffer::CreateRawAliasOfBuffer(
