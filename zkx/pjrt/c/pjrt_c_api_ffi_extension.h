...
#ifndef ZKX_PJRT_C_PJRT_C_API_FFI_EXTENSION_H_
#define ZKX_PJRT_C_PJRT_C_API_FFI_EXTENSION_H_
...
// backend-specific FFI (foreign function interface) library, i.e. for ZKX CPU
// and GPU backends it gives access to the ZKX FFI internals.
//
...
#endif  // ZKX_PJRT_C_PJRT_C_API_FFI_EXTENSION_H_
