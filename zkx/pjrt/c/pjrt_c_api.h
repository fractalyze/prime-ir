...
#ifndef ZKX_PJRT_C_PJRT_C_API_H_
#define ZKX_PJRT_C_PJRT_C_API_H_
...
#define PJRT_STRUCT_SIZE(struct_type, last_field) \
  offsetof(struct_type, last_field) +             \
      sizeof((reinterpret_cast<struct_type*>(0)->last_field))
...
// include `zkx_version`, `stablehlo_current_version`, and
...
// Auto-generated from zkx_data.proto via gen_pjrt_data_types.py.
#include "zkx/pjrt/c/pjrt_c_api_data_types.h"
...
struct PJRT_Executable_GetCompiledMemoryStats_Args {
  ...
  // Mirrors zkx::CompiledMemoryStats.
...
#endif  // ZKX_PJRT_C_PJRT_C_API_H_
