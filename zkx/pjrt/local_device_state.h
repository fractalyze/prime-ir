...
#ifndef ZKX_PJRT_LOCAL_DEVICE_STATE_H_
#define ZKX_PJRT_LOCAL_DEVICE_STATE_H_
...
class LocalDeviceState {
 public:
  ...
  // Returns a fresh, PRNG-generated random seed for a computation.
  int GetNewPrngSeed();
...
#endif  // ZKX_PJRT_LOCAL_DEVICE_STATE_H_
