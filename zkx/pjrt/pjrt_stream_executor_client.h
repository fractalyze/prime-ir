...
#ifndef ZKX_PJRT_PJRT_STREAM_EXECUTOR_CLIENT_H_
#define ZKX_PJRT_PJRT_STREAM_EXECUTOR_CLIENT_H_
...
#include "zkx/pjrt/local_device_state.h"
...
class PjRtStreamExecutorDeviceDescription : public PjRtDeviceDescription {
 public:
  ...
  std::string_view device_kind() const override { return device_kind_; }
...
class PjRtStreamExecutorClient : public PjRtClient {
 public:
  ...
  absl::StatusOr<PjRtDevice*> LookupDevice(
    ...
    return absl::InvalidArgumentError(absl::StrCat(
        "No matching device found for device_id ", global_device_id.value()));
  }
  ...
  std::string_view platform_version() const override { return "<unknown>"; }
  ...
  // An optional `definition_event` may be specified that can be used to
  ...
  CreateBuffersForAsyncHostToDevice(absl::Span<const Shape> shapes,
    ...
    return absl::UnimplementedError(
        "Async transfer to buffers not implemented");
  };
  ...
  LocalDeviceState& device_state(int device_ordinal) const {
    return *tsl::down_cast<PjRtStreamExecutorDevice*>(
                LookupAddressableDevice(zkx::PjRtLocalDeviceId(device_ordinal))
                    .value())
                ->local_device_state();
  }
 ...
 protected:
  ...
  virtual absl::Status EnqueueCrossHostReceive(
    ...
    return absl::UnimplementedError("Cross host receives not implemented.");
  }

  virtual void CopyToRemoteDevice(
      PjRtBuffer* buffer, std::string_view serialized_descriptor,
      PjRtBuffer::RemoteSendCallback on_done) const {
    on_done(absl::UnimplementedError("Cross host sends not implemented."),
  ...
  virtual void CopyToRemoteDeviceScattered(
    ...
    for (const auto& cb : callbacks) {
      cb(absl::UnimplementedError(
             "Scattered cross host sends not implemented."),
         /*sends_were_enqueued=*/false);
    }
  }
  ...
  virtual PjRtFuture<> CopyRawSubBufferToHost(PjRtBuffer* buffer,
    ...
    return PjRtFuture<>(
        absl::UnimplementedError("Raw copies to host not implemented."));
  }
...
class PjRtStreamExecutorBuffer : public PjRtBuffer {
 public:
  ...
  std::string_view platform_name() const { return client_->platform_name(); }
...
// Wraps one or more LocalExecutables (one per partition, as specified by
// the build options).
...
#endif  // ZKX_PJRT_PJRT_STREAM_EXECUTOR_CLIENT_H_
