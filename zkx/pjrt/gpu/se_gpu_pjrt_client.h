...
#ifndef ZKX_PJRT_GPU_SE_GPU_PJRT_CLIENT_H_
#define ZKX_PJRT_GPU_SE_GPU_PJRT_CLIENT_H_
...
class StreamExecutorGpuTopologyDescription : public PjRtTopologyDescription {
 public:
  StreamExecutorGpuTopologyDescription(
      const PjRtPlatformId platform_id, const std::string_view platform_name,
...
class StreamExecutorGpuDevice : public PjRtStreamExecutorDevice {
 public:
  ...
  std::string_view device_vendor() const;
...
class StreamExecutorGpuHbmMemorySpace : public PjRtStreamExecutorMemorySpace {
 public:
  static constexpr std::string_view kKind = "device";
...
class StreamExecutorGpuClient : public PjRtStreamExecutorClient {
 public:
...
#endif  // ZKX_PJRT_GPU_SE_GPU_PJRT_CLIENT_H_
