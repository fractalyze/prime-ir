...
#ifndef ZKIR_UTILS_CONTROLFLOWOPERATION_H_
#define ZKIR_UTILS_CONTROLFLOWOPERATION_H_
    ...
    return b
        ->create<mlir::scf::IfOp>(
            ...
            [&then](mlir::OpBuilder &builder, mlir::Location loc) {
              ...
              mlir::zkir::ScopedBuilderContext scb(&b);
...
#endif // ZKIR_UTILS_CONTROLFLOWOPERATION_H_
