...
// Binary field benchmark - x86 PCLMULQDQ specialization
//
...
// BF64 multiplication using PCLMULQDQ
func.func @bf64_mul_x86(%a: i64, %b: i64) -> i64 attributes { llvm.emit_c_interface } {
...
// BF128 multiplication using PCLMULQDQ
func.func @bf128_mul_x86(%a: i128, %b: i128) -> i128 attributes { llvm.emit_c_interface } {
