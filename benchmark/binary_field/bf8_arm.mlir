...
// Binary field benchmark - BF8 ARM PMULL specialization
//
// Packed 16x BF8 multiplication using ARM PMULL (128-bit NEON).
// Uses memref interface for passing SIMD vectors through C FFI.

!BF8 = !field.bf<3>  // GF(2⁸) tower field

// Packed 16x BF8 multiplication using PMULL
// C interface: void bf8x16_mul_pmull(MemRefDescriptor* a, MemRefDescriptor* b, MemRefDescriptor* c)
func.func @bf8x16_mul_pmull(%a_ptr: memref<16xi8>, %b_ptr: memref<16xi8>, %c_ptr: memref<16xi8>)
  ...
  // Multiply (will be specialized to PMULL)
