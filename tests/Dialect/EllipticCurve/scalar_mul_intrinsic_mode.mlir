...
func.func @test_g1_scalar_mul(%point: !affine, %scalar: !SFm) -> !jacobian {
  // Intrinsic mode: uses intrinsic for all scalar_mul
  // CHECK-INTRINSIC: memref.alloca
  // CHECK-INTRINSIC: call @__prime_ir_ec_scalar_mul_jacobian_
...
func.func @test_g2_scalar_mul(%point: !g2affine, %scalar: !SFm) -> !g2jacobian {
  // Intrinsic mode: uses intrinsic for scalar_mul
  // CHECK-INTRINSIC: memref.alloca
  // CHECK-INTRINSIC: memref.store
  // CHECK-INTRINSIC: call @__prime_ir_ec_scalar_mul_jacobian_
  // CHECK-INTRINSIC: memref.load

  // Auto mode: G2 (extension field) uses intrinsic
  // CHECK-AUTO: memref.alloca
  // CHECK-AUTO: call @__prime_ir_ec_scalar_mul_jacobian_
...
func.func @test_g2_xyzz_scalar_mul(%point: !g2xyzz, %scalar: !SFm) -> !g2xyzz {
  // CHECK-INTRINSIC: call @__prime_ir_ec_scalar_mul_xyzz_
  // CHECK-AUTO: call @__prime_ir_ec_scalar_mul_xyzz_
...
// CHECK-INTRINSIC: func.func private @__prime_ir_ec_scalar_mul_jacobian_
// CHECK-INTRINSIC: func.func private @__prime_ir_ec_scalar_mul_xyzz_

// CHECK-AUTO: func.func private @__prime_ir_ec_scalar_mul_jacobian_
// CHECK-AUTO: func.func private @__prime_ir_ec_scalar_mul_xyzz_
