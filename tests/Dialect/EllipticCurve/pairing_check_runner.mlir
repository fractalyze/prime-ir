...
// RUN: FileCheck %s -check-prefix=CHECK_PAIRING < %t
...
// Bilinearity check: e(3·G1, 5·G2) * e(15·G1, -G2) = 1
// Since 3 * 5 + 15 * (-1) = 0, the product of pairings is the identity in GT.
// CHECK-LABEL: @test_pairing_check
func.func @test_pairing_check() {
  // G1 generator: (1, 2)
