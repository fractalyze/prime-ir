...
func.func @test_constant_folding() -> tensor<8xi32> {
  ...
  // CHECK: return %[[C]] : [[T]]
  %const_reversed = tensor_ext.bit_reverse %const : tensor<8xi32>
...
func.func @test_involution(%arg0: tensor<8xi32>) -> tensor<8xi32> {
  // CHECK-NOT: tensor_ext.bit_reverse
  // CHECK: return %arg0 : [[T]]
  %reversed = tensor_ext.bit_reverse %arg0 : tensor<8xi32>
  %reversed_reversed = tensor_ext.bit_reverse %reversed : tensor<8xi32>
