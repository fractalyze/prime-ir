...
// RUN: prime-ir-opt %s -poly-to-field -field-to-gpu="bufferize-function-boundaries parallelize-affine target-format=llvm nvvm-use-bare-ptr-call-conv" | FileCheck %s
