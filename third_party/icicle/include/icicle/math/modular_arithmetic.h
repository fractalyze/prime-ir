...
#ifdef __CUDACC__
  #include "third_party/icicle/gpu-utils/sharedmem.h"
  #include "third_party/icicle/cuda_math.h"
#endif // __CUDACC__
...
#pragma unroll
  ...
  {
    // is_zero() is HOST_INLINE; on GPU, neg(zero) still works correctly
    // (modulus - 0 = modulus, then sub_modulus reduces to 0).
