...
ABSL_CONST_INIT extern const std::string_view kXlaModuleLineName;
ABSL_CONST_INIT extern const std::string_view kXlaOpLineName;
...
ABSL_CONST_INIT extern const std::string_view kXlaAsyncOpLineName;
