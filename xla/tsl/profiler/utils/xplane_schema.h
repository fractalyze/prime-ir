...
ABSL_CONST_INIT extern const std::string_view kHostThreadsPlaneName;
// Name prefix of XPlane that contains GPU events.
ABSL_CONST_INIT extern const std::string_view kGpuPlanePrefix;
// Name prefix of XPlane that contains TPU events.
ABSL_CONST_INIT extern const std::string_view kTpuPlanePrefix;
// Regex for XPlanes that contain TensorCore planes.
ABSL_CONST_INIT extern const char kTpuPlaneRegex[];
// Regex for XPlanes that contain TPU Core planes.
ABSL_CONST_INIT extern const char kSparseCorePlaneRegex[];
// Name prefix of XPlane that contains custom device events.
ABSL_CONST_INIT extern const std::string_view kCustomPlanePrefix;
// Name prefix of XPlane that contains TPU non-core events such as HBM, ICI etc.
ABSL_CONST_INIT extern const std::string_view kTpuNonCorePlaneNamePrefix;
// Name prefix of XPlane that contains TPU runtime events.
ABSL_CONST_INIT extern const std::string_view kTpuRuntimePlaneName;
// Name of XPlane that contains CUPTI driver API generated events.
ABSL_CONST_INIT extern const std::string_view kCuptiDriverApiPlaneName;
// Name of XPlane that contains Roctracer API generated events.
ABSL_CONST_INIT extern const std::string_view kRoctracerApiPlaneName;
// Name of XPlane that contains profile metadata such as XLA debug info.
ABSL_CONST_INIT extern const std::string_view kMetadataPlaneName;
// Name of XPlane that contains kpi related metrics.
ABSL_CONST_INIT extern const std::string_view kTFStreamzPlaneName;
// Name of XPlane that contains events from python tracer.
ABSL_CONST_INIT extern const std::string_view kPythonTracerPlaneName;
// Name of XPlane that contains kTrace thread-switch events
ABSL_CONST_INIT extern const std::string_view kHostCpusPlaneName;
// Name of XPlane that contains kTrace system calls.
ABSL_CONST_INIT extern const std::string_view kSyscallsPlaneName;
// Name of XPlane that contains namescope stack tree.
ABSL_CONST_INIT extern const std::string_view kScopeRangeIdTreePlaneName;

// Names of XLines that contain ML-level events.
ABSL_CONST_INIT extern const std::string_view kStepLineName;
ABSL_CONST_INIT extern const std::string_view kTensorFlowNameScopeLineName;
ABSL_CONST_INIT extern const std::string_view kTensorFlowOpLineName;
ABSL_CONST_INIT extern const std::string_view kZkxModuleLineName;
ABSL_CONST_INIT extern const std::string_view kZkxOpLineName;
ABSL_CONST_INIT extern const std::string_view kSparseCoreStepLineName;
ABSL_CONST_INIT extern const std::string_view kSparseCoreOpLineName;
ABSL_CONST_INIT extern const std::string_view kSparseCoreModuleLineName;
ABSL_CONST_INIT extern const std::string_view kZkxAsyncOpLineName;
ABSL_CONST_INIT extern const std::string_view kKernelLaunchLineName;
ABSL_CONST_INIT extern const std::string_view kSourceLineName;
ABSL_CONST_INIT extern const std::string_view kCounterEventsLineName;
ABSL_CONST_INIT extern const std::string_view kHostOffloadOpLineName;

// GPU device vendors.
ABSL_CONST_INIT extern const std::string_view kDeviceVendorNvidia;
ABSL_CONST_INIT extern const std::string_view kDeviceVendorAMD;

// Name of Xplane that contains environment information
ABSL_CONST_INIT extern const std::string_view kTaskEnvPlaneName;
...
ABSL_CONST_INIT extern const std::string_view kMegaScaleDcnReceive;
ABSL_CONST_INIT extern const std::string_view kMegaScaleDcnSend;
ABSL_CONST_INIT extern const std::string_view kMegaScaleDcnSendFinished;
ABSL_CONST_INIT extern const std::string_view kMegaScaleDcnMemAllocate;
ABSL_CONST_INIT extern const std::string_view kMegaScaleDcnMemCopy;
ABSL_CONST_INIT extern const std::string_view kMegaScaleTopologyDiscovery;
ABSL_CONST_INIT extern const std::string_view kMegaScaleBarrier;
ABSL_CONST_INIT extern const std::string_view kMegaScaleHostCommand;
ABSL_CONST_INIT extern const std::string_view kMegaScaleD2HTransferStart;
ABSL_CONST_INIT extern const std::string_view kMegaScaleD2HTransferFinished;
ABSL_CONST_INIT extern const std::string_view kMegaScaleH2DTransferStart;
ABSL_CONST_INIT extern const std::string_view kMegaScaleH2DTransferFinished;
ABSL_CONST_INIT extern const std::string_view kMegaScaleReductionStart;
ABSL_CONST_INIT extern const std::string_view kMegaScaleReductionFinished;
ABSL_CONST_INIT extern const std::string_view kMegaScaleCompressionStart;
ABSL_CONST_INIT extern const std::string_view kMegaScaleCompressionFinished;
ABSL_CONST_INIT extern const std::string_view kMegaScaleDecompressionStart;
ABSL_CONST_INIT extern const std::string_view kMegaScaleDecompressionFinished;
ABSL_CONST_INIT extern const char kXProfMetadataKey[];
ABSL_CONST_INIT extern const char kXProfMetadataFlow[];
ABSL_CONST_INIT extern const char kXProfMetadataTransfers[];
ABSL_CONST_INIT extern const char kXProfMetadataBufferSize[];

// String constants for threadpool_listener events
ABSL_CONST_INIT extern const std::string_view kThreadpoolListenerRecord;
ABSL_CONST_INIT extern const std::string_view kThreadpoolListenerStartRegion;
ABSL_CONST_INIT extern const std::string_view kThreadpoolListenerStopRegion;
ABSL_CONST_INIT extern const std::string_view kThreadpoolListenerRegion;
