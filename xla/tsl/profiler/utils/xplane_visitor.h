...
class XStatVisitor {
 public:
  ...
  std::string_view BytesValue() const { return stat_->bytes_value(); }
  ...
  std::string_view StrOrRefValue() const;
...
class XEventMetadataVisitor : public XStatsOwner<XEventMetadata> {
 public:
  ...
  std::string_view DisplayName() const { return metadata()->display_name(); }
...
class XEventVisitor : public XStatsOwner<XEvent> {
 public:
  ...
  std::string_view DisplayName() const { return metadata_->display_name(); }
