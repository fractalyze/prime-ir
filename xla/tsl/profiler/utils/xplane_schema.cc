...
const std::string_view kHostThreadsPlaneName = "/host:CPU";
const std::string_view kGpuPlanePrefix = "/device:GPU:";
const std::string_view kTpuPlanePrefix = "/device:TPU:";
const std::string_view kTpuNonCorePlaneNamePrefix = "#Chip";
...
// migrated.
const std::string_view kCustomPlanePrefix = "/device:CUSTOM:";

const std::string_view kScopeRangeIdTreePlaneName =
    "/host:__ScopeRangeCallStack__";
const std::string_view kTpuRuntimePlaneName = "/host:TPU-runtime";
const std::string_view kCuptiDriverApiPlaneName = "/host:CUPTI";
const std::string_view kRoctracerApiPlaneName = "/host:ROCTRACER";
const std::string_view kMetadataPlaneName = "/host:metadata";
const std::string_view kTFStreamzPlaneName = "/host:tfstreamz";
const std::string_view kPythonTracerPlaneName = "/host:python-tracer";
const std::string_view kHostCpusPlaneName = "Host CPUs";
const std::string_view kSyscallsPlaneName = "Syscalls";

const std::string_view kStepLineName = "Steps";
const std::string_view kSparseCoreStepLineName = "Sparse Core Steps";
const std::string_view kSparseCoreModuleLineName = "Sparse Core Modules";
const std::string_view kSparseCoreOpLineName = "Sparse Core Ops";
const std::string_view kTensorFlowNameScopeLineName = "Framework Name Scope";
const std::string_view kTensorFlowOpLineName = "Framework Ops";
const std::string_view kZkxModuleLineName = "ZKX Modules";
const std::string_view kZkxOpLineName = "ZKX Ops";
const std::string_view kZkxAsyncOpLineName = "Async ZKX Ops";
const std::string_view kKernelLaunchLineName = "Launch Stats";
const std::string_view kSourceLineName = "Source code";
const std::string_view kHostOffloadOpLineName = "Host Offload Ops";
const std::string_view kCounterEventsLineName = "_counters_";

const std::string_view kDeviceVendorNvidia = "Nvidia";
const std::string_view kDeviceVendorAMD = "AMD";

const std::string_view kTaskEnvPlaneName = "Task Environment";
...
using HostEventTypeMap = absl::flat_hash_map<std::string_view, HostEventType>;
using HostEventTypeStrMap =
    absl::flat_hash_map<HostEventType, std::string_view>;
using StatTypeMap = absl::flat_hash_map<std::string_view, StatType>;
using StatTypeStrMap = absl::flat_hash_map<StatType, std::string_view>;
using MegaScaleStatTypeMap =
    absl::flat_hash_map<std::string_view, MegaScaleStatType>;
using MegaScaleStatTypeStrMap =
    absl::flat_hash_map<MegaScaleStatType, std::string_view>;
using LineIdTypeMap = absl::flat_hash_map<std::string_view, LineIdType>;
using LineIdTypeStrMap = absl::flat_hash_map<LineIdType, std::string_view>;
...
using TaskEnvStatTypeMap =
    absl::flat_hash_map<std::string_view, TaskEnvStatType>;
using TaskEnvStatTypeStrMap =
    absl::flat_hash_map<TaskEnvStatType, std::string_view>;
...
// static
std::atomic<uint64_t> XFlow::next_flow_id_(0);

// String constants for XProf TraceMes.
const std::string_view kMegaScaleDcnReceive =
    "MegaScale: Communication Transport Receive";
const std::string_view kMegaScaleDcnSend =
...
const std::string_view kMegaScaleDecompressionStart =
