...
const std::string_view kXlaModuleLineName = "XLA Modules";
const std::string_view kXlaOpLineName = "XLA Ops";
const std::string_view kXlaAsyncOpLineName = "Async XLA Ops";
