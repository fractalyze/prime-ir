...
#ifndef PRIME_IR_DIALECT_MODARITH_IR_MODARITHTYPES_H_
#define PRIME_IR_DIALECT_MODARITH_IR_MODARITHTYPES_H_
...
#include "prime_ir/Dialect/ModArith/IR/ModArithTypes.h.inc"
...
inline unsigned getIntOrModArithBitWidth(Type type) {
  ...
  if (auto modArithType = dyn_cast<ModArithType>(type)) {
    return modArithType.getDenseElementBitSize();
  }
...
#endif // PRIME_IR_DIALECT_MODARITH_IR_MODARITHTYPES_H_
