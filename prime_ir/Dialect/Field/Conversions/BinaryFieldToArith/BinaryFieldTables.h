...
//===----------------------------------------------------------------------===//
//
// Polyval uses the irreducible polynomial: X^128 + X^127 + X^126 + X^121 + 1
...
// - Poly bits: 127, 126, 121 (high), 63, 62, 57 (low = mirrored at 64-bit boundary)
...
// - Tower:   X^128 + X^7 + X^2 + X + 1 (recursive tower construction)
// - Polyval: X^128 + X^127 + X^126 + X^121 + 1 (sparse for fast reduction)
//
